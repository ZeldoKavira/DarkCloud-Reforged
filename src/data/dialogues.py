"""Auto-generated dialogue strings from Dialogues.cs — do not edit manually."""
...
sideQuestDialogueOption = [None] * 2
...
noruneRuby2[8] = 'I remember hearing an old story from^Queens about its ruler La Saia falling^in love with a commoner.¤They say they ran away to be together^forever, how romantic Ȟ'
...
matatakiGoro[2] = 'Hey there, who would have thought the^son of the legendary hunter would be so^handsome! Ȟ'
...
queensXiao[5] = 'Stray cats like you used to be found all^over Queens as the ocean smell would^brings cats from around the world.¤Not many animals can be seen after the^Genie attacked...'
...
queensRuby[5] = 'I´m curious about your hair color^Ʀ, was it always like this?¤It´s a rare color indeed, perhaps it´s^connected to your magic!'
...
queensRuby[8] = 'It would only make sense that a native^of Queens would try to free La Saia from^her curse.¤What happened between her and her lover^was tragic.'
...
queensRuby2[2] = 'The fish were barely biting, it doesn´t^help that the sea is so blue that you^can´t see them either!¤Say, you´re trying to prove that you´re^the most powerful genie, do you know of^any spells that can help?'
...
queensRuby2[5] = 'As a doctor I often have to administer^mighty healing to people who fall ill.¤King´s tough bodyguards Stew and Jake^cried when I had to do them haha!'
...
queensUngaga[5] = 'I had the luxury of travelling all^around the Earth but not once have I^been to Muska Racka.'
...
muskarackaXiao[5] = 'Gosuke and Toto would always pretend to^be warriors and have adventures^together!¤Maybe you could join them and be an^adventurer too!¤You´re a small cat now I´m sure you´ll^change the world one day! Tehehe Ȟ'
...
muskarackaRuby[5] = 'Wow I love your outfit, it´s so cute! Ȟ'
...
muskarackaOsmond[5] = 'You may be small and cuddly, but I bet^you´re quite the warrior! Ȟ'
...
yellowdropsXiao2[11] = 'I admire Ų´s height.^I wish that I can be that tall one day^that way Ō won´t boss^me around!'
yellowdropsXiao2[12] = 'I wish it were possible for me to take^that Sun Giant out for a spin!'

yellowdropsGoro = [None] * 13
...
norunefinishedDialogue = [None] * 13
...
matatakifinishedDialogue = [None] * 12
...
queensfinishedDialogue = [None] * 13
...
# Dark Heaven Castle (area 38) — single dialogue per character (not arrays)
...
darkheavenGoro = 'Once upon a time, long long ago the^Dark Genie ravaged all of Terra: that^is all except your neighbouring^village of Brownboo.¤This tiny village hidden away deep^in the Forest was once the only^surviving bastion from the influence^of the Dark Genie.¤The remaining survivors from all over^Terra journeyed to that village^as a safe haven.¤Many years have since passed and the^Dark Clouds have once again begun to^stir, the black winds have begun to howl^to the two moons.'
